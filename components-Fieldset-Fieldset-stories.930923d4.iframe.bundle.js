"use strict";(self.webpackChunkursa_react=self.webpackChunkursa_react||[]).push([[424],{"./src/components/Fieldset/Fieldset.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Main:()=>Main,__namedExportsOrder:()=>__namedExportsOrder,default:()=>Fieldset_stories});__webpack_require__("./node_modules/react/index.js");var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const StyledFieldset=styled_components_browser_esm.ZP.fieldset`  
  display: flex;
  width: 100%;
  flex-direction: column;
  border: none;
`,Fieldset=_ref=>{let{id,className,form,name,children,disabled}=_ref;return(0,jsx_runtime.jsx)(StyledFieldset,{id,className,form,name,disabled,children})};Fieldset.displayName="Fieldset",Fieldset.defaultProps={};try{Fieldset.displayName="Fieldset",Fieldset.__docgenInfo={description:"",displayName:"Fieldset",props:{disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean"}},form:{defaultValue:null,description:"",name:"form",required:!1,type:{name:"string"}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string"}},id:{defaultValue:null,description:"",name:"id",required:!1,type:{name:"string"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/Fieldset/Fieldset.tsx#Fieldset"]={docgenInfo:Fieldset.__docgenInfo,name:"Fieldset",path:"src/components/Fieldset/Fieldset.tsx#Fieldset"})}catch(__react_docgen_typescript_loader_error){}var Input=__webpack_require__("./src/components/Input/Input.tsx"),Label=__webpack_require__("./src/components/Label/Label.tsx");const Fieldset_stories={title:"Example/Fieldset",component:Fieldset,parameters:{layout:"centered"},tags:["autodocs"]},Main={args:{children:(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(Label._,{children:"Firstname"}),(0,jsx_runtime.jsx)(Input.I,{title:"Firstname",placeholder:"John"})]})}};Main.parameters={...Main.parameters,docs:{...Main.parameters?.docs,source:{originalSource:"{\n  args: {\n    children: <>\n        <Label>Firstname</Label>\n        <Input title='Firstname' placeholder='John' />\n      </>\n  }\n}",...Main.parameters?.docs?.source}}};const __namedExportsOrder=["Main"]},"./src/components/Input/Input.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{I:()=>Input});__webpack_require__("./node_modules/react/index.js");var styled_components__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/react/jsx-runtime.js");const StyledInputContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.ZP.div`
  position: relative;
